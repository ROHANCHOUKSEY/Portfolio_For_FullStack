        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 cursor-pointer'>
          {
            projectList.map((project, id) => (
              <div key={id} className='relative flex flex-col group overflow-hidden h-full rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 bg-white hover:-translate-y-2 dark:bg-gray-800 border border-gray-200 dark:border-gray-700'
